...
export default function Article(){
 ...
 useEffect(() => {
  Axios.get('https://nodejs-server-test-app.herokuapp.com/api/login/user').then((response) => {
    ...
    Axios.get('https://nodejs-server-test-app.herokuapp.com/api/get/articleall').then((response) => {
    ...
    const searchRecords = () =>
    {
        Axios.get(`https://nodejs-server-test-app.herokuapp.com/api/get/article/search/${search}`).then(response => {
          console.log(search);
    ...
    const deleteArticle = (articleId) =>{
      Axios.delete(`https://nodejs-server-test-app.herokuapp.com/api/delete/article/${articleId}`).then(() => {  // with altgr+7 you can add variables to it
      refreshArticleData();
      });
    };
