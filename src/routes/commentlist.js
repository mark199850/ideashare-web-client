...
export default function Comment(){
    ...
    Axios.get('https://nodejs-server-test-app.herokuapp.com/api/get/commentall').then((response) => {
    ...
    const deleteComment = (commentId) =>{
      Axios.delete(`https://nodejs-server-test-app.herokuapp.com/api/delete/comment/${commentId}`).then(() => { // with altgr+7 you can add variables to it
      refreshCommentData();
