...
export default function CreateArticle(){
    ...
    const submitArticleData = () => {
        ...
        Axios.post('https://nodejs-server-test-app.herokuapp.com/api/insert/article/byId', {
    ...
    return(
        <div className="ms-3">
            ...
            <Modal show={showSucUpd} onHide={handleCloseSucUpd}>
                ...
                <Modal.Footer>
                <Button className="lets-go-btn" variant="dark" onClick={() => {handleCloseSucUpd(); routeChange();}}>
                    Let's check it<span className="lets-go-arrow">&#10140;</span>
                </Button>
                </Modal.Footer>
            </Modal>
