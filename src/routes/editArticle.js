...
export default function EditArticle() {
  ...
  const getChoosenArticleById = () => {
    ...
    Axios.get('https://nodejs-server-test-app.herokuapp.com/api/get/article/oneById', {
      headers: {
  ...
  const submitArticleData = () => {
    ...
    Axios.put('https://nodejs-server-test-app.herokuapp.com/api/update/article/byUser', {
      articleId: location.state.id,
