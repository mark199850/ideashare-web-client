...
export default function EditArticle() {
  ...
  useEffect(() => {
    Axios.get(`https://nodejs-server-test-app.herokuapp.com/api/get/article/${location.state.id}`).then((response) => {
  ...
  const submitArticleData = () => {
    ...
    Axios.put('https://nodejs-server-test-app.herokuapp.com/api/update/article/byUser', { //URL for our api (node.js backend)
              ...
              <div className=''>
                  ...
                  >
                    ...
                    <Modal show={ModalState} fullscreen={true} onHide={modalClose}>
                      <Modal.Header className="text-white modalHeaderShadow" closeButton>
