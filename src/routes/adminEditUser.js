...
export default function EditUser() {
  ...
  useEffect(() => {
    Axios.get(`https://nodejs-server-test-app.herokuapp.com/api/get/user/${location.state.id}`).then((response) => {
  ...
  const submitUserData = () => {
    ...
    Axios.put('https://nodejs-server-test-app.herokuapp.com/api/update/user', { //URL for our api (node.js backend)
