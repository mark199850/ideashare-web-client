...
export default function App(){
  ...
  Axios.defaults.withCredentials = true;
    ...
    const submitUserDataReg = () => {
          ...
          Axios.post('https://nodejs-server-test-app.herokuapp.com/api/register/user', { 
          userUn: UserUnReg,
          userPP: UserPPReg,
          userPw: UserPwReg,
          userFN: UserFNReg,
    ...
    const submitUserDataLogin = () => {
      ...
      Axios.post('https://nodejs-server-test-app.herokuapp.com/api/login/user', {
  ...
  const logout = () =>{
    ...
    Axios.get("https://nodejs-server-test-app.herokuapp.com/api/user/logout").then((response) => {
    ...
    <div>
      ...
      <div>
        <Modal show={show} fullscreen={true} onHide={() => setShow(false)}>
          <Modal.Header className="bg-dark text-white modalHeaderShadow" closeButton>
      ...
      {!LoginStatus && (
        ...
        <Modal show={showSucReg} onHide={handleCloseSucReg}>
          ...
          <Modal.Footer>
            <Button className="lets-go-btn" variant="dark" onClick={() => {handleCloseReg(); handleCloseSucReg(); handleShow()}}>
              Let's go to the login page <span className="lets-go-arrow">&#10140;</span>
            </Button>
          </Modal.Footer>
        </Modal>
